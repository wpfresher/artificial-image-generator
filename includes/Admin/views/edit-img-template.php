 ...
 *
 * This file renders the admin view for editing the image template in the Artificial Image Generator plugin.
 *
...
<div class="wrap aimg-wrap">
	<h1>
		<?php esc_html_e( 'Edit Image Template', 'artificial-image-generator' ); ?>
		...
		<div class="columns">
			<div class="column column-left">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input type="text" id="title" name="title" class="regular-text" placeholder="<?php esc_attr_e( 'Awesome image template', 'artificial-image-generator' ); ?>" value="<?php echo esc_attr( $template->post_title ); ?>" required />
					...
					<tr>
						...
						<td>
							<input type="text" id="bg_colors" name="bg_colors" class="regular-text" placeholder="<?php esc_attr_e( 'e.g. #e74c3c, #2ecc71, #9b59b6', 'artificial-image-generator' ); ?>" value="<?php echo esc_attr( get_post_meta( $template->ID, '_aimg_bg_colors', true ) ); ?>" required />
					...
					<tr>
						...
						<td>
							<input type="number" id="width" name="width" class="regular-text" placeholder="<?php esc_attr_e( '1200', 'artificial-image-generator' ); ?>" value="<?php echo esc_attr( get_post_meta( $template->ID, '_aimg_width', true ) ); ?>" min="1" required />
					...
					<tr>
						...
						<td>
							<input type="number" id="height" name="height" class="regular-text" placeholder="<?php esc_attr_e( '800', 'artificial-image-generator' ); ?>" value="<?php echo esc_attr( get_post_meta( $template->ID, '_aimg_height', true ) ); ?>" min="1" required />
					...
					<tr>
						...
						<td>
							<input type="number" id="title_font_size" name="title_font_size" class="regular-text" placeholder="<?php esc_attr_e( '40', 'artificial-image-generator' ); ?>" value="<?php echo esc_attr( get_post_meta( $template->ID, '_aimg_title_font_size', true ) ); ?>" min="1" required />
					...
					<tr>
						...
						<td>
							<label for="is_overlay_image">
								<input type="checkbox" id="is_overlay_image" name="is_overlay_image" value="1" <?php checked( get_post_meta( $template->ID, '_aimg_is_overlay_image', true ), 'yes' ); ?> />
						...
						<td>
							<div class="aimg-overlay-images">
								<div id="overlay-image-list" class="aimg-overlay-images__items">
									<?php
									$aimg_overlay_images = json_decode( get_post_meta( $template->ID, '_aimg_overlay_images', true ) );
								...
								<input type="hidden" id="overlay_images" name="overlay_images" value="<?php echo esc_attr( get_post_meta( $template->ID, '_aimg_overlay_images', true ) ); ?>"/>
					...
					<tr>
						...
						<td>
							<?php $aimg_overlay_position = get_post_meta( $template->ID, '_aimg_overlay_position', true ); ?>
			...
			<div class="column column-right">
				<div class="preview-section">
					...
					<?php $aimg_preview_image_url = get_post_meta( $template->ID, '_aimg_preview_image_url', true ); ?>
